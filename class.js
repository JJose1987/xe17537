    ...
    common_functions_db2() {
        ...
        if (kwargs['cursor'] && this.kwargs['subpgm'] != 'batch') {
            ...
            this.kwargs['cursor'][i++] = ''
                ...
                + (('trx|rut|').indexOf(this.kwargs['subrut']) >= 0?''
                    + '\n     DISPLAY \'*\''
                    + '\n     DISPLAY \'QNU-FILAS   \' QNU-FILAS-QPIPCCAB'
                    + '\n     DISPLAY \'XSN-PRIMERO \' XSN-PRIMERO-QPIPCCAB'
                    + '\n     DISPLAY \'*\''
                    + '\n*'
                :'')
                ...
                + (('trx|rut|').indexOf(this.kwargs['subrut']) >= 0?''
                    + '\n     DISPLAY \'*\''
                    + '\n     DISPLAY \'XSN-MASDATOS \' XSN-MASDATOS-QPIPCCAB'
                    + '\n     DISPLAY \'QNU-FILENV   \' QNU-FILENV-QPIPCCAB'
                    + '\n     DISPLAY \'*\''
                    + '\n*'
                :'')
                + '\n     .'
    ...
    common_functions_programa() {
        ...
        if (this.kwargs['subrut'] == 'trx') {
            ...
            this.kwargs['trx'][i++] = ''
                ...
                + '\n     MOVE COD-OFICINA-QPEJCAQA      TO COD-OFICINA-QPIPCCAB'
                + '\n     MOVE COD-PUESTO-QPEJCAQA       TO COD-PUESTO-QPIPCCAB'
                + '\n     MOVE COD-CANAL-QPEJCAQA        TO COD-CANAL-QPIPCCAB'
                + '\n     MOVE COD-MEDIO-QPEJCAQA        TO COD-MEDIO-QPIPCCAB'
                + '\n     MOVE COD-APLCANAL-QPEJCAQA     TO COD-APLCANAL-QPIPCCAB'
                + '\n     MOVE COD-IDIOMA-QPEJCAQA       TO COD-IDIOMA-QPIPCCAB'
                + '\n     MOVE COD-USUARIO-QPEJCAQA      TO COD-USUARIO-QPIPCCAB'
                + '\n     MOVE FEC-CANAL-QPEJCAQA        TO FEC-CONTABLE-QPIPCCAB'
                + '\n     MOVE HMS-CANAL-QPEJCAQA        TO HMS-PROCESO-QPIPCCAB'
                + '\n     MOVE COD-BANCO-OPER-QPEJCAQA   TO COD-BANCO-OPER-QPIPCCAB'
                + '\n     MOVE COD-OFICINA-OPER-QPEJCAQA TO COD-OFICINA-OPER-QPIPCCAB'
                + '\n     MOVE COD-DIVISA-BASE-QPEJCAQA  TO COD-DIVISA-BASE-QPIPCCAB'
                + '\n                                       COD-DIVISA-QPIPCCAB'
                + '\n     MOVE COD-DIVISA-SEC-QPEJCAQA   TO COD-DIVISA-SEC-QPIPCCAB'
                + '\n     MOVE FEC-PROCESO-QPEJCAQA      TO FEC-PROCESO-QPIPCCAB'
                + '\n     MOVE HMS-PROCESO-QPEJCAQA      TO HMS-PROCESO-QPIPCCAB'
                + '\n     MOVE XSN-LOGINCID-QPEJCAQA     TO XSN-LOGINCID-QPIPCCAB'
                + '\n*';
            this.kwargs['trx'][i++] = '';
            this.kwargs['trx'][i++] = ''
                + '\n     DISPLAY \'*************************************************\''
    ...
    common_functions_jcl() {
        ...
        if (kwargs['file_exist']) {
            this.kwargs['file_exist'][i++] = ''
                ...
                + '\n//**********************************************************************'
                + '\n//VALEXIST IF (IFEXISTS.P20.RC > 0) THEN'
                + '\n//**********************************************************************'
                + '\n//*---------------------------------------------------------------------'
                + '\n//*---------------------------------------------------------------------'
                + '\n//**********************************************************************'
...
/* Genera una rutina */
    nobatch() {
        ...
        out += '\n*                   DESCRIPCION DEL PROGRAMA'
            ...
            + '\n 400000-INFORMAR-DCLGEN.'
            + '\n*'
            + '\n     DISPLAY \'400000-INFORMAR-DCLGEN\''
            + '\n     DISPLAY \'*************************************************\''
            + '\n*'
            + '\n     .'
            + '\n*'
            ...
            + '\n 500000-RETORNAR-CONSULTA.'
            + '\n*'
            + '\n     DISPLAY \'500000-RETORNAR-CONSULTA\''
            + '\n     DISPLAY \'*************************************************\''
            + '\n*'
            + '\n     ADD  CTN-1                        TO WS-IND'
            + '\n*'
